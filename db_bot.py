...
questions = [
    "How many hours has Alice Johnson worked this week?",
    "Which projects involve security?",
    "What is the total cost of the Data Migration project?",
    "Who has contributed to more than one project?",
    "What tags are associated with the Mobile App Launch project?",
    "What are the names of all projects owned by Bob Lee?",
    "Who worked on Campus Kiosk App on May 31?",
    "Which contributors have an hourly rate over 90?"
]
